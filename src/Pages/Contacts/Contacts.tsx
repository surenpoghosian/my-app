  ...
  const defaultOptions = {
    ...
    return (
      <div className={styles.wrapper}>
        <Parallax pages={2}>
            <ParallaxLayer  offset={window.innerWidth < 1200 ? 0.05 : 0.15} speed={0.5} >
            ...
            <ParallaxLayer  offset={window.innerWidth < 1200 ? 0.33 : 0.45} speed={0.4} style={{ zIndex:1, height:'60px' }}>
                <div className={styles.cardImageWrapper}>
          ...
          <ParallaxLayer offset={window.innerWidth < 1200 ? 0.4 : 0.5} speed={0.25} style={{...alignCenter, height:'400px'}} >
            <ContactForm/>
          </ParallaxLayer>
