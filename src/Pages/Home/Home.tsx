...
export const Home: React.FC = () => {
    ...
    return (
        <div className={styles.container}>
            <Parallax pages={window.innerWidth < 1200 ? 3 : 3.5} ref={parallax}>
                ...
                <ParallaxLayer offset={0.9} speed={1.5} style={{ ...alignCenter, justifyContent: 'center'}} onClick={()=>{window.location.replace('/projects')}}>
                    <div className={`${styles.card}  ${styles.parallax}`} style={{cursor:'pointer'}} onClick={()=>{window.location.replace('/about')}}> 
                        <h2 >About Me</h2>
                ...
                {/* <ParallaxLayer offset={window.innerWidth < 1200 ? 1.5 : 1} speed={1.5} style={{ ...alignCenter, justifyContent: 'center'}} onClick={()=>{window.location.replace('/projects')}}>
                    <div className={`${styles.card} ${styles.parallax}`} style={{cursor:'pointer'}}>
                        <h2>Software Architecture <br/> and <br/> Software Design Patterns</h2>
                        <img src="/assets/PC3.png" alt="Project" className={styles.cardImage} />
                        <p style={{color: 'gray'}}>Explore my recent work related to <b>Software Architecture</b>  and <b>Software Design Patterns</b>.</p>
                    </div>
                </ParallaxLayer> */}

                <ParallaxLayer offset={window.innerWidth < 1200 ? 1 : 1.1} speed={1.5} style={{ ...alignCenter, marginTop: 150, justifyContent: 'center' }} onClick={()=>{window.location.replace('/projects')}}>
                    <div className={`${styles.card} ${styles.parallax}`} style={{cursor:'pointer'}} >
                        <h2>My Projects</h2>
                ...
                {/* <ParallaxLayer offset={2} speed={1.5} style={{ ...alignCenter, justifyContent: 'center' }} onClick={()=>{window.location.replace('/about')}}>
                    <div className={`${styles.card} ${styles.parallax}`} style={{cursor:'pointer'}}>
                ...
                {/* <ParallaxLayer offset={2.5} speed={1.5} style={{ ...alignCenter, justifyContent: 'center' }} onClick={()=>{window.location.replace('/about')}}>
                    <div className={`${styles.card} ${styles.parallax}`} style={{cursor:'pointer'}}>
                        <h2>Testimonials</h2>
                ...
                <ParallaxLayer offset={window.innerWidth < 1200 ? 2 : 3} speed={1.5} style={{ ...alignCenter, justifyContent: 'center', cursor:'pointer', marginTop:'100px' }} onClick={()=>{window.location.replace('/contacts')}}>
